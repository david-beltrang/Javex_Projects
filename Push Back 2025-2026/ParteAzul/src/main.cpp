...
/*
    ...
    moveDistance(45, 85); // Mover hacia adelante 14 pulgadas a velocidad 80%
    rotateOnAxis(-93 , 85, pid); // Girar 90 grados a la derecha velocidad 80%
    moveDistance(26, -40);
    ...
    moveDistance(27, 20);
    BarraLoader.open();
    rotateOnAxis(-4, 20, pid); // Girar 90 grados a la izquierda a velocidad 80%
    
    moveDistance(9, 100); // Mover hacia adelante 14 pulgadas a velocidad 80%
    moveDistanceConRecoleccionSinTirar(5.5, 100, 70); // Mover hacia adelante 14 pulgadas a velocidad 80% con recolección activa
    recoleccionAlmacenar(60, 2); // Activar recolección durante 3 segundos a velocidad 100%
*/    
    moveDistance(5, -20); // Mover hacia atrás 14 pulgadas a velocidad 80%
    BarraLoader.close();
    moveDistance(50, -20); // Mover hacia atrás 14 pulgadas a velocidad 80%
    recoleccionSubir(100, 6); // Activar recolección durante 3 segundos a velocidad 100%
